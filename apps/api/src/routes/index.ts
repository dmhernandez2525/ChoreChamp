  ...
  fastify.register(
    async (api) => {
      ...
      api.register(async (householdApi) => {
        ...
        householdApi.register(storyModeRoutes, { prefix: '/:householdId/story-mode' });
        ...
        householdApi.register(qrVerificationRoutes, { prefix: '/:householdId/qr-verification' });
        householdApi.register(geofencingRoutes, { prefix: '/:householdId/geofencing' });
        ...
        householdApi.register(skillBuildingRoutes, { prefix: '/:householdId/skill-building' });
