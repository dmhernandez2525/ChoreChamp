...
export const cachedHouseholds = sqliteTable('cached_households', {
  ...
  subscriptionBillingInterval: text('subscription_billing_interval'),
  ...
  subscriptionTrialEndsAt: text('subscription_trial_ends_at'),
  subscriptionGracePeriodEndsAt: text('subscription_grace_period_ends_at'),
  subscriptionCancelAtPeriodEnd: integer('subscription_cancel_at_period_end', { mode: 'boolean' }).default(false),
  subscriptionCanceledAt: text('subscription_canceled_at'),
  subscriptionIsGrandfathered: integer('subscription_is_grandfathered', { mode: 'boolean' }).default(false),
  subscriptionMemberLimit: integer('subscription_member_limit'),
  themeId: text('theme_id').default('classic'),
  whiteLabelEnabled: integer('white_label_enabled', { mode: 'boolean' }).default(false),
